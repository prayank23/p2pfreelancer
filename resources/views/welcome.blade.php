...
<!-- Mirrored from premiumlayers.net/demo/html/vertikal/home-shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Nov 2019 11:59:36 GMT -->
<head>
	...
	<script type="text/javascript" src="{{asset('front/js/jquery.nouislider.min.js')}}"></script>
	...
	<div id="container" class="container">
		...
		<header class="clearfix">
			<div class="header-logo">
				<a class="logo" href="#"><img alt="" src="{{asset('front/images/logo.png')}}"></a>
			</div>
			<a class="elemadded responsive-link" href="#">Menu</a>
			<div class="navbar-vertical">
				<ul class="main-menu">

					<li class="drop"><a class="active" href="index-2.html"><span>Home</span></a>
						<ul class="drop-down">
					...
					<li class="drop"><a href="portfolio-3col.html"><span>Portfolio</span></a>
						<ul class="drop-down">
					...
					<li class="drop"><a href="blog-right-sidebar.html"><span>Blog</span></a>
						<ul class="drop-down">
						...
						<div class="fullwidthbanner">
							<ul>
								...
								<li data-transition="3dcurtain-vertical" data-slotamount="10" data-masterspeed="300">
									...
									<img alt="" src="{{asset('front/upload/slider-revolution/1.jpg')}}">
									...
									<div class="caption large_text sfb"
										 ...
										 data-speed="600"
										 data-start="1200"
										 data-easing="easeOutExpo" data-end="7000" data-endspeed="300" data-endeasing="easeInSine" >Hello, We Are <span>Vertikal</span></div>
									...
									<div class="caption big_white sft stt"
										 ...
										 data-speed="500"
										 data-start="1400"
										 data-easing="easeOutExpo" data-end="7100" data-endspeed="300" data-endeasing="easeInSine" >Creative Web Design Based on Melbourne</div>
									...
									<div class="caption randomrotate"
										 ...
										 data-speed="600"
										 data-start="1600"
										 data-easing="easeOutExpo" data-end="7200" data-endspeed="300" data-endeasing="easeInSine" ><img src="{{asset('front/images/slider-icons/circle.png')}}" alt="Image 1"></div>
									...
									<div class="caption randomrotate"
										 ...
										 data-speed="600"
										 data-start="1800"
										 data-easing="easeOutExpo" data-end="7400" data-endspeed="300" data-endeasing="easeInSine" ><img src="{{asset('front/images/slider-icons/circle1.png')}}" alt="Image 2"></div>
									...
									<div class="caption randomrotate"
										 ...
										 data-speed="600"
										 data-start="2000"
										 data-easing="easeOutExpo" data-end="7500" data-endspeed="300" data-endeasing="easeInSine" ><img src="{{asset('front/images/slider-icons/circle2.png')}}" alt="Image 3"></div>
								...
								<li data-transition="papercut" data-slotamount="15" data-masterspeed="300">
									...
									<img alt="" src="{{asset('front/upload/slider-revolution/2.jpg')}}">
									...
									<div class="caption randomrotate"
										 ...
										 data-speed="600"
										 data-start="1200"
										 data-easing="easeOutExpo" data-end="7000" data-endspeed="300" data-endeasing="easeInSine" ><img src="{{asset('front/images/slider-icons/image.png')}}" alt="Image 1"></div>
								...
								<li data-transition="turnoff" data-slotamount="1" data-masterspeed="300">
									...
									<img alt="" src="{{asset('front/upload/slider-revolution/3.jpg')}}">
									...
									<div class="caption large_text sfb"
										 ...
										 data-speed="600"
										 data-start="1200"
										 data-easing="easeOutExpo" data-end="7000" data-endspeed="300" data-endeasing="easeInSine" >We Build Awesome<span> Websites</span></div>
									...
									<div class="caption medium_grey sft stt"
										 ...
										 data-speed="500"
										 data-start="1300"
										 data-easing="easeOutExpo" data-end="7100" data-endspeed="300" data-endeasing="easeInSine" >Creative Applications With User-Friendly Design</div>
									...
									<div class="caption randomrotate"
										 ...
										 data-speed="600"
										 data-start="1500"
										 data-easing="easeOutExpo" data-end="7300" data-endspeed="300" data-endeasing="easeInSine" ><img src="{{asset('front/images/slider-icons/icon8.png')}}" alt="Image 2"></div>
									...
									<div class="caption randomrotate"
										 ...
										 data-speed="600"
										 data-start="1600"
										 data-easing="easeOutExpo" data-end="7400" data-endspeed="300" data-endeasing="easeInSine" ><img src="{{asset('front/images/slider-icons/icon9.png')}}" alt="Image 3"></div>
									...
									<div class="caption randomrotate"
										 ...
										 data-speed="600"
										 data-start="2300"
										 data-easing="easeOutExpo" data-end="8000" data-endspeed="300" data-endeasing="easeInSine" ><img src="{{asset('front/images/slider-icons/icon14.png')}}" alt="Image 7"></div>
									...
									<div class="caption randomrotate"
										 ...
										 data-speed="600"
										 data-start="2500"
										 data-easing="easeOutExpo" data-end="8300" data-endspeed="300" data-endeasing="easeInSine" ><img src="{{asset('front/images/slider-icons/icon11.png')}}" alt="Image 10"></div>
								</li>
							</ul>
						</div>
					</div>
							...
							<div class="col-md-8 shop-section">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="product-post">
											<div class="product-post-gal">
												<img alt="" src="{{asset('front/upload/image5.jpg')}}">
									...
									<div class="col-md-6">
										<div class="product-post">
											<div class="product-post-gal">
												<img alt="" src="{{asset('front/upload/image7.jpg')}}">
								...
								<div class="sidebar-widgets">
									...
									<div class="shop-widget">
										...
										<ul class="popular-product">
											<li>
												<img alt="" src="{{asset('front/images/product.png')}}">
												<div>
											...
											<li>
												<img alt="" src="{{asset('front/images/product2.png')}}">
												<div>
							...
							<div class="col-md-4">
								<div class="widget footer-widgets flickr-widget">
									...
									<ul class="flickr-list">
										<li><a href="#"><img alt="" src="{{asset('front/images/flickr1.png')}}"></a></li>
										<li><a href="#"><img alt="" src="{{asset('front/images/flickr2.png')}}"></a></li>
										<li><a href="#"><img alt="" src="{{asset('front/images/flickr3.png')}}"></a></li>
										<li><a href="#"><img alt="" src="{{asset('front/images/flickr4.png')}}"></a></li>
										<li><a href="#"><img alt="" src="{{asset('front/images/flickr5.png')}}"></a></li>
										<li><a href="#"><img alt="" src="{{asset('front/images/flickr6.png')}}"></a></li>
									</ul>
								</div>
							</div>
...
<!-- Mirrored from premiumlayers.net/demo/html/vertikal/home-shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Nov 2019 11:59:38 GMT -->
</html>