    ...
    <div class="main-content">
        ...
        <div class="main-content-inner">
            @if ($errors->any())
                ...
                @endforeach
            @endif
            <form action="{{route('admin.update.gig.category',['gigCategory'=>$category->id])}}" method="POST">
            @csrf
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Category</h4>
                            <p class="alert alert-info"> If you want to create Main Category then no need to select <strong>main category</strong> </p>
