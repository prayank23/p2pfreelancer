        ...
        <div class="inner-content">
            ...
            <div class="content-sections">
                ...
                <div class="row">
                    <div class="col-md-6">
            <div class="card">
  <img src="{{asset('front/images/users/'.$user->avatar)}}" alt="John" style="width:100%">
  <h1>{{$user->getName()}}</h1>
  <p class="title">{{$user->getPhone()}}</p>
  <br>
  <p class="title">{{$user->getEmail()}}</p>
<br>
  <p><button>Message Now</button></p>
</div>
</div>
<div class="col-md-6">
    <div class="">
        <img class="img-responsive" src="https://i.pinimg.com/originals/60/17/da/6017da3ed8f203fe979b16dae1ad2259.png"
            >
        <div class="row">
            <div class="col-lg-12">
                <p class="t3">Lorem ipsum dolor sit amet, consectetur
                            ...
                            <div class="container">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <p class="text-2">{{$user->getEmail()}}</p>
                                        </div>
                                    </div>
                                    <br>
                                    <hr>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <p class="text-1">Phone No:</p>
                                        </div>
                                        <div class="col-lg-6">
                                            <p class="text-2">{{$user->getPhone()}}</p>
                                        </div>
                                        <br>
                                    </div>
                                    ...
                                    <!-- <div class="row">
                                        <div class="col-lg-12">
                                            <div id="contact-form-2">
                                                <input type="submit" class="main-form" data-toggle="modal"
                                                    data-target="#myModal" value="Send Message"
                                                    style="border-color: #5CB85C; background-color: #5CB85C;">
                                            </div>
                                        </div>
                                    </div> -->
                                    <br>
                                        ...
                                        <div class="col-lg-12">
                                            <div id="contact-form-2">
                                                <input type="submit" name="mailing-submit"
                                                    class="submit_contact main-form" value="Hire Me">
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                        ...
                        <div class="row" style="">
                            <div class="col-lg-12">
                                <!-- <button class="btn btn-danger"
                                    style="float: right;border-color: #FF5851; background-color: #FF5851; border-radius: 0px;"
                                    data-toggle="modal" data-target="#myModal2">ADD GIGS&nbsp;&nbsp;<i
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="contact-form-3" class="contact-work-form2">
                                                    <div class="text-input">
                                                        ...
                                                        <div class="float-input2">
                                                            <input name="mail" type="text" placeholder="Last Name">
                                                            <span><i class="fa fa-user"></i></span>
                                                        </div>
                                                    </div>
                                                    <div class="text-input">
                                                        <div class="float-input">
                                                            <input name="mail" id="mail2" type="text"
                                                                placeholder="E-mail"> <span><i
                                                                    class="fa fa-envelope"></i></span>
                                                        </div>
                                                        <div class="float-input2">
                                                            <input name="name" type="text" placeholder="Phone No#">
                                                            <span><i class="fa fa-phone"></i></span>
                                                        </div>
                                                    </div>
                                                    <div class="textarea-input">
                                                        <textarea name="comment" placeholder="Skills"></textarea>
                                                        <span><i class="fa fa-tasks"></i></span>
                                                    </div>
                                                    <div class="textarea-input">
                                                        <textarea name="comment" placeholder="Experience"></textarea>
                                                        <span><i class="fa fa-comment"></i></span>
                                                    </div>
                                                    <div class="msg2 message"></div>
                                                    <input type="submit" data-dismiss="modal" class="main-form"
                                                        value="Close">
                                                    <input type="submit" name="mailing-submit" class="main-form"
                                                        value="Submit">
                                                </form>
                                            </div>
                                        </div>
